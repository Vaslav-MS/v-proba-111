...
root = tk.Tk()
root.title("Первый графический интерфейс")
label = tk.Label(root, text="Это первый текстик в этом новом окне!")
label.pack()
